...
CDP_PORT="${ANIMA_BROWSER_CDP_PORT:-${ANIMABOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${ANIMA_BROWSER_CDP_SOURCE_RANGE:-${ANIMABOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${ANIMA_BROWSER_VNC_PORT:-${ANIMABOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${ANIMA_BROWSER_NOVNC_PORT:-${ANIMABOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${ANIMA_BROWSER_ENABLE_NOVNC:-${ANIMABOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${ANIMA_BROWSER_HEADLESS:-${ANIMABOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${ANIMA_BROWSER_NO_SANDBOX:-${ANIMABOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${ANIMA_BROWSER_NOVNC_PASSWORD:-${ANIMABOT_BROWSER_NOVNC_PASSWORD:-}}"
