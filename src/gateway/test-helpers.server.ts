...
const GATEWAY_TEST_ENV_KEYS = [
  ...
  "ANIMA_STATE_DIR",
  "ANIMA_CONFIG_PATH",
  "ANIMA_SKIP_BROWSER_CONTROL_SERVER",
  "ANIMA_SKIP_GMAIL_WATCHER",
  "ANIMA_SKIP_CANVAS_HOST",
  "ANIMA_BUNDLED_PLUGINS_DIR",
  "ANIMA_SKIP_CHANNELS",
  "ANIMA_SKIP_PROVIDERS",
  "ANIMA_SKIP_CRON",
  "ANIMA_TEST_MINIMAL_GATEWAY",
] as const;
...
export async function startServerWithClient(
  ...
  const envSnapshot = captureEnv(["ANIMA_GATEWAY_TOKEN"]);
