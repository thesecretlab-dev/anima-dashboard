...
describe("callGateway password resolution", () => {
  ...
  beforeEach(() => {
    envSnapshot = captureEnv(["ANIMA_GATEWAY_PASSWORD", "ANIMA_GATEWAY_TOKEN"]);
    resetGatewayCallMocks();
  ...
  it.each([
    ...
    if (envPassword !== undefined) {
      process.env.ANIMA_GATEWAY_PASSWORD = envPassword;
    }
