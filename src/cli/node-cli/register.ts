    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "anima node run --host 127.0.0.1 --port 18789",
            "Run the node host in the foreground.",
          ],
          ["anima node status", "Check node host service status."],
          ["anima node install", "Install the node host service."],
          ["anima node restart", "Restart the installed node host service."],
