      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["anima gateway run", "Run the gateway in the foreground."],
            ["anima gateway status", "Show service status and probe reachability."],
            ["anima gateway discover", "Find local and wide-area gateway beacons."],
            ["anima gateway call health", "Call a gateway RPC method directly."],
