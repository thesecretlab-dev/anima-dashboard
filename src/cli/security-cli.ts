    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["anima security audit", "Run a local security audit."],
          ["anima security audit --deep", "Include best-effort live Gateway probe checks."],
          ["anima security audit --fix", "Apply safe remediations and file-permission fixes."],
          ["anima security audit --json", "Output machine-readable JSON."],
