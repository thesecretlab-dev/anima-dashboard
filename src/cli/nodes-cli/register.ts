    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["anima nodes status", "List known nodes with live status."],
          ["anima nodes pairing pending", "Show pending node pairing requests."],
          ['anima nodes run --node <id> --raw "uname -a"', "Run a shell command on a node."],
          ["anima nodes camera snap --node <id>", "Capture a photo from a node camera."],
