    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["anima channels list", "List configured channels and auth profiles."],
          ["anima channels status --probe", "Run channel status checks and probes."],
          [
            "anima channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["anima channels login --channel whatsapp", "Link a WhatsApp Web account."],
