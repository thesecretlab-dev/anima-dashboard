    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["anima memory status", "Show index and provider status."],
          ["anima memory index --force", "Force a full reindex."],
          ['anima memory search --query "deployment notes"', "Search indexed memory entries."],
          ["anima memory status --json", "Output machine-readable JSON."],
