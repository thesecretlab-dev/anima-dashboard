    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["anima directory self --channel slack", "Show the connected account identity."],
          [
            'anima directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["anima directory groups list --channel discord", "List available groups/channels."],
          [
            "anima directory groups members --channel discord --group-id <id>",
