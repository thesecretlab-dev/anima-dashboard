...
export const GATEWAY_LAUNCH_AGENT_LABEL = "ai.anima.gateway";
...
export const NODE_LAUNCH_AGENT_LABEL = "ai.anima.node";
...
export function resolveGatewayServiceDescription(params: {
  ...
  return (
    ...
    formatGatewayServiceDescription({
      profile: params.env.ANIMA_PROFILE,
      version: params.environment?.ANIMA_SERVICE_VERSION ?? params.env.ANIMA_SERVICE_VERSION,
    })
  );
}
