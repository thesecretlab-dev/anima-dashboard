...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.anima.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", ANIMA_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.anima.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when ANIMA_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.anima.gateway.plist",
    },
    {
      name: "uses profile-specific label when ANIMA_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", ANIMA_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.anima.jbphoenix.plist",
    },
    {
      name: "prefers ANIMA_LAUNCHD_LABEL over ANIMA_PROFILE",
      env: {
        HOME: "/Users/test",
    ...
    {
      name: "trims whitespace from ANIMA_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        ANIMA_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty ANIMA_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        ANIMA_PROFILE: "myprofile",
        ANIMA_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.anima.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
