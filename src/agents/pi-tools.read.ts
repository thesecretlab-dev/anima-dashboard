...
function resolveAdaptiveReadMaxBytes(options?: ANIMAReadToolOptions): number {
...
export function createANIMAReadTool(
  base: AnyAgentTool,
  options?: ANIMAReadToolOptions,
): AnyAgentTool {
