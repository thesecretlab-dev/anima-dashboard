...
export function resolveSessionToolsVisibility(cfg: ANIMAConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: ANIMAConfig): "spawned" | "all" {
