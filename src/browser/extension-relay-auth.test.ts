...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated anima relay probe responses", async () => {
    ...
    try {
      const ok = await probeAuthenticatedANIMARelay({
        baseUrl: `http://127.0.0.1:${port}`,
        relayAuthHeader: "x-anima-relay-token",
