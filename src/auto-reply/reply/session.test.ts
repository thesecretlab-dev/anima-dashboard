  ...
  it("applies WhatsApp group reset authorization across sender variants", async () => {
    ...
    const cases = [
      ...
      },
      {
        ...
        storePrefix: "anima-group-reset-unauth-",
        allowFrom: ["+41796666864"],
      ...
      },
      {
        ...
        storePrefix: "anima-group-rawbody-",
        allowFrom: ["*"],
      ...
      },
      {
        ...
        storePrefix: "anima-group-reset-lid-",
        allowFrom: ["+41796666864"],
      ...
      },
      {
        ...
        storePrefix: "anima-group-reset-lid-unauth-",
        allowFrom: ["+41796666864"],
...
describe("initSessionState reset triggers in Slack channels", () => {
  ...
  it("supports mention-prefixed Slack reset commands and preserves args", async () => {
    ...
    const cases = [
      {
        name: "reset command",
        storePrefix: "anima-slack-channel-reset-",
      ...
      },
      {
        ...
        storePrefix: "anima-slack-channel-new-",
...
describe("initSessionState preserves behavior overrides across /new and /reset", () => {
  ...
  it("/new in a new session does not preserve overrides", async () => {
    const storePath = await createStorePath("anima-new-no-preserve-");
  ...
  it("archives the old session store entry on /new", async () => {
    const storePath = await createStorePath("anima-archive-old-");
...
describe("persistSessionUsageUpdate", () => {
  ...
  it("uses lastCallUsage for totalTokens when provided", async () => {
    const storePath = await createStorePath("anima-usage-");
