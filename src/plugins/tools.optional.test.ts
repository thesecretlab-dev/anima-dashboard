...
const loadANIMAPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadANIMAPlugins: (params: unknown) => loadANIMAPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadANIMAPluginsMock.mockReturnValue(registry);
  return registry;
}

describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadANIMAPluginsMock.mockReset();
  });
