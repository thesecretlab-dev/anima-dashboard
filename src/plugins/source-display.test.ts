...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/anima/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/anima/extensions",
        global: "/Users/x/.anima/extensions",
        workspace: "/Users/x/ws/.anima/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.anima/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/anima/extensions",
        global: "/Users/x/.anima/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.anima/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/anima/extensions",
        global: "/Users/x/.anima/extensions",
