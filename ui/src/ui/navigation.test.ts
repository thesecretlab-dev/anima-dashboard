...
describe("normalizeBasePath", () => {
  it("normalizes base-path variants", () => {
    const cases = [
      ...
      { input: "/ui/", expected: "/ui" },
      { input: "/", expected: "" },
      { input: "/apps/anima", expected: "/apps/anima" },
    ] as const;
    for (const testCase of cases) {
...
describe("pathForTab", () => {
  it("builds tab paths with optional bases", () => {
    const cases = [
      ...
      { tab: "sessions", base: "/apps/anima", expected: "/apps/anima/sessions" },
    ] as const;
    for (const testCase of cases) {
      expect(
...
describe("tabFromPath", () => {
  it("resolves tabs from path variants", () => {
    const cases = [
      ...
      { path: "/apps/anima/sessions", base: "/apps/anima", expected: "sessions" },
...
describe("inferBasePathFromPathname", () => {
  it("infers base-path variants from pathname", () => {
    const cases = [
      ...
      { path: "/apps/anima/sessions", expected: "/apps/anima" },
